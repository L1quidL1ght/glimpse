      ...
      <CardContent className="p-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-4 flex-1">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-6">
                ...
                {/* Section and Table */}
                {reservation.section && <div className="flex items-center gap-1 text-sm text-muted-foreground font-semibold">
                    <MapPin className="w-4 h-4" />
                    <span>{reservation.section}{reservation.table_id ? ` - Table ${reservation.table_id}` : ''}</span>
                  </div>}
                
                {/* Special Requests - now on the same line */}
                {reservation.special_requests && <div className="flex items-center gap-1 text-sm text-muted-foreground">
          ...
          <div className="flex items-center gap-2 ml-4">
            {canToggleCompletion && <Button variant="outline" size="sm" onClick={handleCompletionToggle} className={isCompleted ? "bg-green-600 text-white hover:bg-green-700 border-input" : "text-green-600 hover:bg-green-50 border-input"}>
